export default class Graph {
    ...
    addEdge(v, w) { //v e w são vértices
        ...
        // Se o grafo não for direcionado, devemos criar também a aresta w -> v
    ...
    removeVertex(v) {
        ...
        // Verifica se o vértice que está sendo excluído está presente na lista de adjacência de algum outro vértice
        ...
        // Para que um vértice possa ser removido, sua lista de adjacência deve estar vazia e ele não pode estar referenciado por nenhum outro vértice
        if (this.adjList.get(v).size == 0 && !referenced) {
            ...
            throw new Exception('ERRO: impossível excluir um vértice com arestas incidentes a ele.')
        }
    }
    ...
    removeEdge(v, w) { // v e w são os vértices incidentes à aresta
        ...
        // Se o grafo não for direcionado, precisamos excluir também a resta em sentido oposto
